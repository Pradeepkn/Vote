...
final class Cache {
    ...
    private init() {
        NotificationCenter.default.addObserver(self, selector: #selector(Cache.clearSessionCache), name: UIApplication.didReceiveMemoryWarningNotification, object: nil)
    }
